...
'UWU131HD': [349990,1], 'FS1230HD': [249990,0]}
...
def busqueda_precio(precio_min,precio_max):
            ...
            for modelo,datos in stock.items():
                ...
                if precio_min<=precio or precio<=precio_max and  cantidad>0:
...
#######Menu principal########
#############################
print("Bienvenido a la tienda tecnologicas Psycho-Mantis"n/"por favor eliga una opcion"n/"1)stock de marca"n/"2)busqueda por precio"n/"3)eliminar producto""4)salir")
opcion=input("opcion:")
if opcion==1:
